...
namespace Hazel {
    ...
    static ImGuiKey HazelKeyToImGuiKey(int key)
    {
        switch (key)
        {
    ...
    static void UpdateImGuiModifiers()
    {
        ...
        io.AddKeyEvent(
            ImGuiMod_Super,
            glfwGetKey(glfwGetCurrentContext(), GLFW_KEY_LEFT_SUPER) == GLFW_PRESS ||
	...
	bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& e)
	{
        ...
        UpdateImGuiModifiers();

        ImGuiKey key = HazelKeyToImGuiKey(e.GetKeyCode());
